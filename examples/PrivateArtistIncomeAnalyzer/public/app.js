// Privacy Artist Income Analyzer DApp
let provider, signer, contract;
let userAddress;

const CONTRACT_ADDRESS = "0x742d35Cc6aF3e2F27a4bEC3b3f5aC4f1B8eE92C8"; // Replace with deployed address
const CONTRACT_ABI = [
...
async function submitIncomeData() {
    ...
    try {
        ...
        showStatus('Failed to submit income data: ' + error.message, 'error');
    } finally {
...
async function submitCreativeAnalytics() {
    ...
    try {
        ...
        showStatus('Failed to submit analytics: ' + error.message, 'error');
    } finally {
...
async function finalizeReport() {
    try {
        ...
        showStatus('Failed to finalize report: ' + error.message, 'error');
    } finally {
